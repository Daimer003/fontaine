              ...
              <nav aria-label="Page navigation example">
                <ul className="pagination">
                  <li className="page-item">
                    <a
                      className={`page-link ${currentCoursePage === 1 ? "disabled" : ""
                        }`}
                      aria-label="Previous"
                      onClick={() =>
                  ...
                  {Array.from({ length: totalCoursePages }, (_, index) => (
                    <li className="page-item" key={index}>
                      <a
                        className={`page-link ${currentCoursePage === index + 1 ? "active" : ""
                          }`}
                  ...
                  <li className="page-item">
                    <a
                      className={`page-link ${currentCoursePage === totalCoursePages ? "disabled" : ""
                        }`}
                      aria-label="Next"
                      onClick={() =>
                        handleCoursePageChange(currentCoursePage + 1)
