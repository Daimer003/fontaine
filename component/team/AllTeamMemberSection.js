...
const AllTeamMemberSection = () => {
  ...
  return (
    <section className="tf__team_page">
      <div className="container">
        <div className="row wow fadeInUp">
          <div className="col-xl-6 col-md-8 col-lg-6 m-auto">
            <div className="tf__heading_area mb_15">
              <h5>Equipo</h5>
              <h2>Equipo del colegio la Fontaine.</h2>
            </div>
          </div>
        </div>
        <div className="row">
              ...
              <nav aria-label="Page navigation example">
                <ul className="pagination">
                  <li className="page-item">
                    <a
                      className={`page-link ${currentTeamPage === 1 ? "disabled" : ""
                        }`}
                      aria-label="Previous"
                  ...
                  {Array.from({ length: totalTeamPages }, (_, index) => (
                    <li className="page-item" key={index}>
                      <a
                        className={`page-link ${currentTeamPage === index + 1 ? "active" : ""
                          }`}
                  ...
                  <li className="page-item">
                    <a
                      className={`page-link ${currentTeamPage === totalTeamPages ? "disabled" : ""
                        }`}
                      aria-label="Next"
                      onClick={() => handleTeamPageChange(currentTeamPage + 1)}
                    >
