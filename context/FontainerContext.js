...
const FontaineContext = createContext();

export const FontaineProvider = ({ children }) => {
...
export const useFontaineContext = () => {
  const context = useContext(FontaineContext);
  if (!context) {
    throw new Error("useFontaineContext must be used within an Provider");
  }
  return context;
};
